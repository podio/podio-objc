...
static NSString * const PKFileDataHostedByHumanizedNameKey = @"HostedByHumanizedName";
...
@synthesize hostedByHumanizedName = hostedByHumanizedName_;
...
- (id)initWithCoder:(NSCoder *)aDecoder {
  ...
  if (self) {
    ...
    hostedByHumanizedName_ = [[aDecoder decodeObjectForKey:PKFileDataHostedByHumanizedNameKey] copy];
...
- (void)encodeWithCoder:(NSCoder *)aCoder {
  ...
  [aCoder encodeObject:hostedByHumanizedName_ forKey:PKFileDataHostedByHumanizedNameKey];
...
+ (id)dataFromDictionary:(NSDictionary *)dict {
  ...
  data.hostedByHumanizedName = [dict pk_objectForKey:@"hosted_by_humanized_name"];
